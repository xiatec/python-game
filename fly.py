...
icon = pygame.image.load(
    '/Users/xiatian/Documents/computer_study/python/pygame/ufo.png')
pygame.display.set_icon(icon)
bgImg = pygame.image.load(
    '/Users/xiatian/Documents/computer_study/python/pygame/bg.png')

# 添加背景音效
pygame.mixer.music.load(
    '/Users/xiatian/Documents/computer_study/python/pygame/bg.wav')
pygame.mixer.music.play(-1)  # 单曲循环
# 创建射中音效
bao_sound = pygame.mixer.Sound(
    '/Users/xiatian/Documents/computer_study/python/pygame/exp.wav')

# 5.飞机
playerImg = pygame.image.load(
    '/Users/xiatian/Documents/computer_study/python/pygame/player.png')
playerX = 400  # 玩家的X坐标
playerY = 500  # 玩家的Y坐标
...
class Enemy():
    def __init__(self):
        self.img = pygame.image.load(
            '/Users/xiatian/Documents/computer_study/python/pygame/enemy.png')
...
class Bullet():
    def __init__(self):
        self.img = pygame.image.load(
            '/Users/xiatian/Documents/computer_study/python/pygame/bullet.png')
